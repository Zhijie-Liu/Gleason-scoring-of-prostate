...
if __name__ == '__main__':
    select = 0
    if select == 0:
        img_dir = 'score20220505/NaLianSheng contrast.tif'
        net_path = 'score20220505/InceptionResNetV2params_Adamepochs100.pkl'
    elif select == 1:
    ...
    cv2.imwrite(os.path.join(dir_path, file_name) + '_0.png', data0_img)
    ...
    cv2.imwrite(os.path.join(dir_path, file_name) + '_1.png', data1_img)
    ...
    cv2.imwrite(os.path.join(dir_path, file_name) + '_2.png', data2_img)
    ...
    cv2.imwrite(os.path.join(dir_path, file_name) + '_3.png', data3_img)
    ...
    cv2.imwrite(os.path.join(dir_path, file_name) + '_no.png', datano_img)
