...
if __name__ == '__main__':
    select = 0
    if select == 0:
        img_path = 'score20211122_twonet/'
        net_path1 = 'date20211123000413crossvalid 20211122twoclass/InceptionResNetV2params_Adamepochs120.pkl'
    ...
    for img_dir in img_list:
        ...
        cv2.imwrite(os.path.join(dir_path, file_name) + '_50 pixels per step two net.png', prob_all)
